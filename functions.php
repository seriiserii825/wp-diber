...
if ( ! function_exists( 'bs_diber_setup' ) ) :
	/**
	 ...
	 */
	function bs_diber_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on bs-diber, use a find and replace
		 * to change 'bs-diber' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bs-diber', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'bs-diber' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'bs_diber_custom_background_args', array(
...
add_action( 'after_setup_theme', 'bs_diber_setup' );
